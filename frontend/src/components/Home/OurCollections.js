  ...
  return (
    <>
      <div className="w-full h-auto" id="collections">
        <h1 className="text-center text-4xl py-12 font-bold">Our <span className="text-primary">collection</span> </h1>
        <div className="container mx-auto max-w-screen-sm sm:max-w-screen-xl grid md:grid-cols-3 justify-items-center">
          <div className="w-72 h-72 bg-mysecondarygray mb-20">
            ...
            <p className="text-center mt-8 font-bold text-xl">Air Max Pegasus 37</p>
          </div>
          ...
          <div className="w-72 h-72 bg-mysecondarygray mb-20">
            <img src="assets/nike7.png" alt="" />
            <p className="-mt-10 text-center font-semibold">Rp.99.999</p>
            <p className="text-center mt-8 font-bold text-xl">Air Max Pegasus 37</p>
          </div>

          <div className="w-72 h-72 bg-mysecondarygray mb-20">
            <img src="assets/nike9.png" alt="" />
            <p className="-mt-10 text-center font-semibold">Rp.99.999</p>
            <p className="text-center mt-8 font-bold text-xl">Air Max Pegasus 37</p>
          </div>

          <div className="w-72 h-72 bg-mysecondarygray mb-10">
            <img src="assets/nike10.png" alt="" />
            <p className="-mt-10 text-center font-semibold">Rp.99.999</p>
            <p className="text-center mt-8 font-bold text-xl">Air Max Pegasus 37</p>
          </div>
        </div>
